...
module tb_brent_kung_32_32nm;
    ...
    initial begin
        $display("----- start Brent-Kung 32 (32nm) tests -----");
        ...
        $display("----- end Brent-Kung 32 (32nm) tests -----");
        $finish;
    end
