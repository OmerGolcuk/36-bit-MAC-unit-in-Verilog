...
Hi, this repository includes the laboratory assignments of the VLSI (Very Large Scale Integrated Circuit) Design course.
...
- Lab 1: `Adder_Topologies/Adder_Topologies/`
  - This is the first lab that implements different adder methodologies like ripple carry, carry select, brent-kung, kogge-stone etc. The theoretical background on this is given in the report.
